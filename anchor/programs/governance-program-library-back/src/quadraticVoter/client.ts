...
export class QuadraticClient extends Client<Quadratic> {
  ...
  constructor(
    public program: Program<Quadratic>,
  ...
  async configureRegistrar(
    ...
    return methodsBuilder.instruction();
  }
  ...
  public static convertCoefficientsFromAnchorType(coefficients: {
    a: number;
    b: number;
    c: number;
  }): Coefficients {
  ...
  public static applyCoefficients(
    inputVoterWeight: BN,
  ...
  async updateVoterWeightRecord(
    ...
    const inputVoterWeightPk = await this.getPredecessorVoterWeightRecordPDA(
      realm,
      mint,
      voter,
      inputRecordCallback,
