  ...
  instructions: [
    ...
    },
    {
      ...
      accounts: [
        {
          name: 'registrar';
          docs: ['Registrar for which we configure this Collection'];
          writable: true;
        },
        {
          name: 'realm';
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: 'voterTokenOwnerRecord';
          docs: ['TokenOwnerRecord of the voter who cast the original vote'];
        },
        {
          name: 'voterAuthority';
          docs: [
  ...
  types: [
    {
      ...
      docs: ['Configuration of an NFT collection used for governance power'];
      type: {
        kind: 'struct';
        fields: [
          {
